...
export class FoxSchemaSqlBuilder implements INodeType {
	description: INodeTypeDescription = {
		...
		version: 1,
		description:
			'SQL Builder powered by FoxSchema (Postgres, CockroachDB, YugabyteDB, Redshift, MySQL/MariaDB, TiDB, SQL Server, Azure SQL, Oracle, SQLite, DuckDB, ClickHouse). Db2 is not supported.',
